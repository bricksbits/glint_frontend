...
class _ChatWithScreenState extends State<ChatWithScreen> {
            ...
            children: [
              CircleAvatar(
                backgroundImage: NetworkImage(
                  scale: 0.3,
                  widget.passedChannel.image ?? '',
                ),
              ),
              const Gap(8),
              Text(
                widget.passedChannel.name ?? 'Chat', // Display channel name
              ...
              child: StreamMessageListView(
                ...
                messageBuilder: (context, details, messages, defaultMessage) {
                  ...
                  if (hasAttachments) {
                    ...
                    isOneTimeView =
                        imageReceived.extraData['one_time_view'] == true;
                    hasBeenViewed = imageReceived.extraData['viewed'] == true;
                  }
            ...
            StreamMessageInput(
              ...
              sendButtonBuilder: (context, textController) {
                return chatCircularIconButton(
                  ...
                  padding: const EdgeInsets.all(8),
                  onPressed: () async {
                    final channel = widget.passedChannel;
  ...
  Widget _chatImageMessageBubble(bool allowImage) {
    return Container(
