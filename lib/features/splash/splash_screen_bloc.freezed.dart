...
abstract class _$$NavigateToImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({String newRoute});
}

/// @nodoc
class __$$NavigateToImplCopyWithImpl<$Res>
    extends _$SplashScreenStateCopyWithImpl<$Res, _$NavigateToImpl>
...
class _$NavigateToImpl implements _NavigateTo {
  const _$NavigateToImpl(this.newRoute);
  ...
  @override
  String toString() {
    return 'SplashScreenState.navigateTo(newRoute: $newRoute)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, newRoute);
...
abstract class _NavigateTo implements SplashScreenState {
  const factory _NavigateTo(final String newRoute) = _$NavigateToImpl;
