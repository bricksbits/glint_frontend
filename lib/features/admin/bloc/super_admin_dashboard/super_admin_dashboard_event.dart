...
class SuperAdminDashboardEvent with _$SuperAdminDashboardEvent {
  ...
  const factory SuperAdminDashboardEvent.approveEvent(String eventId) =
      _ApproveEvent;

  const factory SuperAdminDashboardEvent.rejectEvent(String eventId) =
      _RejectEvent;
  ...
  const factory SuperAdminDashboardEvent.updateStates(
      SuperAdminDashboardState state) = _UpdateStates;
}
