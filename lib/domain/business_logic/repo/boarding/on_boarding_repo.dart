...
const String NEW_ON_BOARD_USER_ID = "14022025";

abstract class OnBoardingRepo {
  Future<Result<void>> updateUserDetailsLocally(
    RegisterUserRequest updatedModel,
  );
  ...
  Future<void> setupCurrentBoardingState(
      OnBoardingCompletedTill currentBoardingStep);

  Future<void> insertUser(RegisterUserRequest newTempUser);
}
